...
for file in range(np.shape(target1_box)[0]):
    ...
    with open(label_file_path + '/' + file + '.txt', 'w') as f:
        ...
        f.write(str(3) + ' ' + str(target3_1_box_convert[i][0]) + ' ' + str(target3_1_box_convert[i][1]) + ' '
                + str(target3_1_box_convert[i][2]) + ' ' + str(target3_1_box_convert[i][3]) + '\n')
        f.write(str(3) + ' ' + str(target3_2_box_convert[i][0]) + ' ' + str(target3_2_box_convert[i][1]) + ' '
                + str(target3_2_box_convert[i][2]) + ' ' + str(target3_2_box_convert[i][3]) + '\n')
        f.write(str(3) + ' ' + str(target3_3_box_convert[i][0]) + ' ' + str(target3_3_box_convert[i][1]) + ' '
                + str(target3_3_box_convert[i][2]) + ' ' + str(target3_3_box_convert[i][3]) + '\n')
        f.write(str(3) + ' ' + str(target3_4_box_convert[i][0]) + ' ' + str(target3_4_box_convert[i][1]) + ' '
