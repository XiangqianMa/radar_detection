...
# 从mat文件中提取原始标定信息
path = '/home/mxqian/Projects/production_practice/data/data2/condition2_2_a.mat'
# 从经过可视化后的图片文件中提取文件名信息
image_path = "/home/mxqian/Projects/production_practice/data_convert/data2/condition2_2_a"
# 存放标记文件的目录
label_file_path = "/home/mxqian/Projects/production_practice/data_convert/label_file/data2/condition2_2_a"
...
for file in range(np.shape(target1_box)[0]):
    ...
    with open(label_file_path + '/' + file + '.txt', 'w') as f:
        ...
        f.write(str(3) + ' ' + str(target3_box_convert[i][0]) + ' ' + str(target3_box_convert[i][1]) + ' '
