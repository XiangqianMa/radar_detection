...
# 从mat文件中提取原始标定信息
path = '/home/mxqian/Projects/production_practice/data/data3/target1+2/target2_2/data331_2.mat'
# 从经过可视化后的图片文件中提取文件名信息
image_path = "/home/mxqian/Projects/production_practice/data_convert/data3/target1+2/target2_2/data331_2"
# 存放标记文件的目录
label_file_path = "/home/mxqian/Projects/production_practice/data_convert/label_file/data3/target1+2/target2_2/data331_2"
...
# 写入标记文件
for file in range(np.shape(target2_box)[0]):
    i = file
    file = str('312223312') + str(file + 1)
