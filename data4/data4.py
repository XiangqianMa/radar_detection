...
# 从mat文件中提取原始标定信息
path = '/home/mxqian/Projects/production_practice/data/data4/160921_11_7_180-195.mat'
# 从经过可视化后的图片文件中提取文件名信息
image_path = "/home/mxqian/Projects/production_practice/data_convert/data4/160921_11_7_180-195"
# 存放标记文件的目录
label_file_path = "/home/mxqian/Projects/production_practice/data_convert/label_file/data4/160921_11_7_180-195"
...
for file in range(np.shape(target1_box)[0]):
    i = file
    file = str('4160921117180195') + str(file + 1)
